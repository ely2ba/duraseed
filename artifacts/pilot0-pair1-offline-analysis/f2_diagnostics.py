"""Local, descriptive pair-1 MAPS failure/length and baseline-item summaries."""
...
RUN = REPO / "runs/pilot0/pilot0-pair1-seed11-20260825T125100Z"
...
def evaluation_path(method: str, index: int) -> Path:
    ...
    return RUN / "seed-11" / method / "stage-b" / segment / "b-validation"
...
def markdown(data: dict) -> str:
    text = ["# Pair-1 F2 failure, length, and baseline concentration diagnostics",

...
| Three-cohort panel freeze | **UNRESOLVED; FEASIBLE CURE IDENTIFIED** | Exact old/current replay passed. The original match-first rule selected 24 families, but only 12/24 passed the required single-family test split. A later outcome-blind audit found 31/49 families with unchanged 22/22 capacity under all-candidate protection, proving that a valid 24-family pool exists. No panels are published until the prospective de-duplicate-before-match amendment is accepted and replayed. |
